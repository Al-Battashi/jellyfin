...
For a command-only guide (macOS/Linux/Windows, with `--webdir`, `--ffmpeg`, and dedicated data/cache examples), see [`docs/START_JELLYFIN_COMMANDS.md`](docs/START_JELLYFIN_COMMANDS.md).
